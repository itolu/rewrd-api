...
router.patch("/config", validateRequest(updateConfigSchema), updateMerchantConfig);
 ...
 */
router.get("/rules", getEarningRules);
 ...
 */
router.get("/rules/:id", validateRequest(getRuleSchema), getEarningRule);
 ...
 */
router.get("/security/ip-whitelist", getIpWhitelist);
router.put("/security/ip-whitelist", validateRequest(updateIpWhitelistSchema), updateIpWhitelist);
 ...
 */
router.get("/analytics", validateRequest(getAnalyticsSchema), getAnalytics);
